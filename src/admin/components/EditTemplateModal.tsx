...
import { editTemplateSchema, EditTemplateFormData } from '../schemas/templateSchema';
...
interface EditTemplateModalProps {
  ...
  template: any; // Template type from Convex
  onSuccess?: () => void;
}
...
export const EditTemplateModal: React.FC<EditTemplateModalProps> = ({
  ...
  const updateTemplate = useMutation(api.admin.updateTemplate);
  ...
  const handleSubmit: SubmitHandler<EditTemplateFormData> = async (data) => {
    try {
      ...
      toast({
        ...
        description: `Template "${data.name}" foi atualizado.`,
      });
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Edite as informações do template. Todos os campos marcados com * são obrigatórios.
          </DialogDescription>
        </DialogHeader>
